...
async function upsertSong(track, notice, year) {
...
async function upsertExercises(songId, track, chosen, notice, tsIndex, year) {
...
async function addTrack(track) {
  ...
  const songId   = await upsertSong(track, notice, year);
  const inserted = await upsertExercises(songId, track, chosen, notice, tsIndex, year);
